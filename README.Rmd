...
**textplot** is a suite of text plotting tools that enable the user to analyze text data via serveral common text plotting methods.  Methods include lexical dispersion plots, tree maps, speech networks, speech Gantt charts, text hilighting, and word clouds.
