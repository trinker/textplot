...
#' )
#' 
#' term_regex <- with(termco::presidential_debates_2012, 
...
#' )
#' 
#' token_match <- with(termco::presidential_debates_2012, 
...
#' 
#' 
#' sent_regex <- with(termco::presidential_debates_2012, 
...
#' 
#' 
#' sent_index <- with(termco::presidential_debates_2012, 
